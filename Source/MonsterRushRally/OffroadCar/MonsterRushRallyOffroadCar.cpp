...
#include "MonsterRushRallyOffroadCar.h"
#include "MonsterRushRallyOffroadWheelFront.h"
#include "MonsterRushRallyOffroadWheelRear.h"
...
AMonsterRushRallyOffroadCar::AMonsterRushRallyOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMonsterRushRallyOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMonsterRushRallyOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMonsterRushRallyOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMonsterRushRallyOffroadWheelRear::StaticClass();

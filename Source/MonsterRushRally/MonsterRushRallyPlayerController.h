...
#include "MonsterRushRallyPlayerController.generated.h"

class UInputMappingContext;
class AMonsterRushRallyPawn;
class UMonsterRushRallyUI;
 ...
 */
UCLASS(abstract)
class AMonsterRushRallyPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AMonsterRushRallyPawn> VehiclePawn;

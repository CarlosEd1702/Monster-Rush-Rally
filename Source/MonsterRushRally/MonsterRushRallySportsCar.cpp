...
#include "MonsterRushRallySportsCar.h"
#include "MonsterRushRallySportsWheelFront.h"
#include "MonsterRushRallySportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AMonsterRushRallySportsCar::AMonsterRushRallySportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMonsterRushRallySportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMonsterRushRallySportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMonsterRushRallySportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMonsterRushRallySportsWheelRear::StaticClass();
